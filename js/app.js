...
const workObject = [{
  id: 1,
  workCardTitle: ['Tonic'],
  imagesMobile: ['./images/Todo-Project-1.png', './images/mps1.png'],
  imagesDesk: ['./images/Todo-Project-1.png', './images/desk-snap-1.png'],
  imageAlt: ['Tonic Project'],
  cardTitleMo: ['TODO LIST', 'Multi-Post Stories'],
  cardTitleDesk: ['TODO LIST', 'Multi-Post Stories'],
  titleElementsMo: ['DAMES', 'WebDevJr', '2022'],
  titleElementsDesk: ['DAMES', 'WebDevJr', '2022', 'FACEBOOK', 'Full Stack Dev', '2015'],
  cardDescriptionMo: ['This is a simple and powerful TO-DO-List App. Users can add|delete|re-organize a list of tasks on a single page application.'],
  cardDescriptionDesk: ['This is a simple and powerful TO-DO-List App. Users can add|delete|re-organize a list of tasks on a single page application.', 'Experimental content creation feature that allows users to add to an existing story over the course of a day without spamming their friends.'],
